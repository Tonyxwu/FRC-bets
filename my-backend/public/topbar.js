(function () {
  ...
  style.textContent = [
    ...
    '.top-bar-center { flex: 0 0 auto; display: flex; align-items: center; gap: 12px; }',
    '.top-bar-center .balance { color: #22c55e; font-family: "JetBrains Mono", monospace; font-weight: 600; white-space: nowrap; display: inline-flex; align-items: center; line-height: 1; }',
